...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/analysis/list/add.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/analysis/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/analysis/view/update-analysis.js')}}"></script>
