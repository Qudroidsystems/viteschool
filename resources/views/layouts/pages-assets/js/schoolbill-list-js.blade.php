...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbill/list/add.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbill/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbill/view/update-schoolbill.js')}}"></script>
