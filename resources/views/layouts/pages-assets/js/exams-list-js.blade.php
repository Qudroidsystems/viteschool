...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/exams/list/add.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/exams/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/exams/view/update-exams.js')}}"></script>
