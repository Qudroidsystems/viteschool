...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/list/add.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/view/update-schoolbilltermsession.js')}}"></script>
