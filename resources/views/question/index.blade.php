            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="d-flex flex-wrap flex-stack my-5">
                    <h2 class="fs-2 fw-semibold my-2">
                        Manage Questions
                        <span class="fs-6 text-gray-400 ms-1">for {{ $exam->title }}</span>
                    </h2>
                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-900px">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <form id="kt_modal_add_question_form" class="form" action="{{ route('questions.store', $exam->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($question->image)
                                            ...
                                            <img src="{{ asset('storage/' . $question->image) }}" alt="Question Image" style="max-width: 100px; max-height: 100px;">
                                    ...
                                    <td>
                                               ...
                                               <div class="d-flex justify-content-end">
                                                    ...
                                                    data-id="{{ $question->id }}" title="View">view
