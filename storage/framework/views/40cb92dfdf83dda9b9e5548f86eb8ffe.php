        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    <span class="fw-semibold text-gray-800 fs-6"><?php echo e($userbio->address ?? 'Nill'); ?></span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/users/overview.blade.php ENDPATH**/ ?>