                ...
                <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                            ...
                            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                               ...
                               Student Bills for  Term and Session
                                        </h1>
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('schoolpayment.index')); ?>" class="text-muted text-hover-primary">All Students</a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                              ...
                              <!--begin::Toolbar-->
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                                                    <i class="ki-duotone ki-plus fs-2"></i>     Select  Term and Session
                                                </button>
                                                <!--end::Add user-->
                                    </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header" id="kt_modal_add_user_header">
                                                        <!--begin::Modal title-->
                                                        <h2 class="fw-bold">  Select Term and Session</h2>
                                                        <!--end::Modal title-->
                                                    ...
                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_add_user_form" class="form" action="<?php echo e(route('schoolpayment.termsessionpayments')); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <!--begin::Scroll-->
                                                                  ...
                                                                  <div class="mb-7">
                                                                    ...
                                                                    <!--end::Label-->
                                                                            ...
                                                                            <div class="fv-row mb-7">
                                                                                    ...
                                                                                    <select name ="termid" id="termid" data-control="select2" data-placeholder="Select an option" data-hide-search="true" class="form-select form-select-solid form-select-lg fw-semibold fs-6 text-gray-700">
                                                                          ...
                                                                          <div class="mb-7">
                                                                            ...
                                                                            <!--end::Label-->
                                                                                    ...
                                                                                    <div class="fv-row mb-7">
                                                                                            ...
                                                                                            <select name ="sessionid" id="sessionid" class="sel-sesson form-control form-control-solid mb-3 mb-lg-0" data-control="select2" data-placeholder="Select an option" data-hide-search="true"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/schoolpayment/termSession.blade.php ENDPATH**/ ?>