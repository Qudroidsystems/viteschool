                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subject_class-edit')): ?>
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <a  href="<?php echo e(route('schoolpayment.show',$sc->id)); ?>"  data-toggle="tooltip" title=" School Bill Payment for <?php echo e($sc->firstname); ?> <?php echo e($sc->lastname); ?>"  class=" btn btn-light btn-active-primary" >Proceed to Payment</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    <?php endif; ?>
                                                </div>
