                ...
                <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                            ...
                            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                              ...
                              <p style="color: green" >School Bill Payments</p>
                                        </h1>
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('schoolpayment.index')); ?>" class="text-muted text-hover-primary">Student Management </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                                                ...
                                                <!--end::Item-->
                                                        ...
                                                        <!--begin::Item-->
                                                                <li class="breadcrumb-item text-muted">School BIlls  for Students</li>
                                                            <!--end::Item-->
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subject_class-edit')): ?>
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <a  href="<?php echo e(route('schoolpayment.termsession',$sc->id)); ?>"  data-toggle="tooltip" title=" School Bill Payment for <?php echo e($sc->firstname); ?> <?php echo e($sc->lastname); ?>"  class=" btn btn-light btn-active-primary" >Proceed to Payment</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    <?php endif; ?>
                                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/schoolpayment/index.blade.php ENDPATH**/ ?>