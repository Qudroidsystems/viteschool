                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('schoolbill.index')); ?>" class="text-muted text-hover-primary">Student Result </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                                                ...
                                                <!--end::Item-->
                                                        ...
                                                        <!--begin::Item-->
                                                                <li class="breadcrumb-item text-muted">Student Result</li>
                                                            <!--end::Item-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/studentresults/index.blade.php ENDPATH**/ ?>