                                                                                ...
                                                                                <div class="fv-row mb-7">
                                                                                        ...
                                                                                        <select name ="class_id" id="class_id" data-control="select2" data-placeholder="Select an option" data-hide-search="true" class="form-select form-select-solid form-select-lg fw-semibold fs-6 text-gray-700">
                                                                                            ...
                                                                                            <?php $__currentLoopData = $schoolclasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schoolclass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                             <option value="<?php echo e($schoolclass->id); ?>"><?php echo e($schoolclass->schoolclass); ?> <?php echo e($schoolclass->schoolarm); ?></option>
                                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                        </select>
                                                                                        <!--end::Input-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/analysis/analysis.blade.php ENDPATH**/ ?>