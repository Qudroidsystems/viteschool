...
<head>
  ...
  ================================================== -->
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('website/images/apple-touch-icon.png')); ?>">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo e(asset('website/images/apple-touch-icon-72x72.png')); ?>">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo e(asset('website/images/apple-touch-icon-114x114.png')); ?>">
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('website/css/scrolling-nav.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('website/css/style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('website/css/color.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('website/css/layout.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('website/css/font-awesome.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('website/css/fontello.css')); ?>" />
    <!-- Owl Stylesheets -->
    <link rel="stylesheet" href="<?php echo e(asset('website/js/owl/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('website/js/owl/css/owl.theme.default.min.css')); ?>">
    <!-- LayerSlider style files -->
    <link rel="stylesheet" href="<?php echo e(asset('website/js/layerslider/css/layerslider.css')); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('website/js/fancybox/jquery.fancybox.css')); ?>" />
    <!--    <link rel="stylesheet" href="<?php echo e(asset('website/css/color.css')); ?>" />-->
    <!-- HTML5 Shiv
	================================================== -->
    <script src="<?php echo e(asset('website/js/jquery.modernizr.js')); ?>"></script>
</head>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav id="header" class="navbar navbar-default navbar-fixed-top transparent" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <h1 id="logo">
                    <a class="navbar-brand page-scroll" href="#page-top"><img alt="" class="ls-bg" src="<?php echo e(asset('website/images/logo.png')); ?>"></a>
                </h1>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse navigation">
                <ul class="nav navbar-nav">
                    ...
                    <li ><a href="<?php echo e(route('login')); ?>" class="page-scroll" >School Portal </a>
        ...
        <section id="slider" class="page">
            <section class="section padding-off">
                <div id="layerslider-container">
                    <div id="layerslider">
                        <div class="ls-slide" style="slidedirection: left; durationin: 1500; durationout: 1500; easingin: easeInOutQuint; timeshift: -500;"> <img alt="" class="ls-bg" src="<?php echo e(asset('website/images/layerslider/slider-1.jpg')); ?>">
                        ...
                        <!--/ .ls-layer-->
                        <div class="ls-slide" style="slidedirection: right; durationin: 1500; durationout: 1500; easingin: easeInOutQuint; timeshift: -500;"> <img alt="" class="ls-bg" src="<?php echo e(asset('website/images/layerslider/slider-2.jpg')); ?>">
                        ...
                        <!--/ .ls-layer-->
                        <div class="ls-slide" style="slidedirection: right; durationin: 1500; durationout: 1500; easingin: easeInOutQuint; timeshift: -500;"> <img alt="" class="ls-bg" src="<?php echo e(asset('website/images/layerslider/slider-3.jpg')); ?>">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-7 opacity ">
                            <p> <img src="<?php echo e(asset('website/images/temp/university.jpg')); ?>" alt="" /> </p>
                        </div>
                        <!--/ .col-md-6-->
                        <div class="col-md-5">
                        ...
                        <div class="col-xs-12" id="demos">
                            <div id="testiminial-slider" class="owl-carousel owl-theme">
                                <div class="item align-center">
                                    ...
                                    <div class="quote-image"><img alt="Jack Black" src="<?php echo e(asset('website/images/testimonials/jack-70x70.jpg')); ?>"></div>
                                ...
                                <div class="item align-center">
                                    ...
                                    <div class="quote-image"><img alt="Jack Black" src="<?php echo e(asset('website/images/testimonials/amanda-70x70.jpg')); ?>"></div>
                                ...
                                <div id="team-slider" class="owl-carousel owl-theme team-contents clearfix">
                                        ...
                                        <div class="contents clearfix">
                                            <div class="team-info">
                                                <div class="team-image">
                                                    <a class="single-image team-plus-icon" href="#team-1"><img src="<?php echo e(asset('website/images/testimonials/ann-252x270.jpg')); ?>" alt="" /></a>
                                                </div>
                                    ...
                                    <div class="item scale">
                                        <div class="contents clearfix">
                                            <div class="team-info">
                                                <div class="team-image">
                                                    <a class="single-image team-plus-icon" href="#"><img src="<?php echo e(asset('website/images/testimonials/jack-252x270.jpg')); ?>" alt="" /></a>
                                                </div>
                                                <hgroup class="team-group">
                                    ...
                                    <div class="item scale">
                                        <div class="contents clearfix">
                                            <div class="team-info">
                                                <div class="team-image">
                                                    <a class="single-image team-plus-icon" href="#"><img src="<?php echo e(asset('website/images/testimonials/ingrid-252x270.jpg')); ?>" alt="" /></a>
                                                </div>
                                                <hgroup class="team-group">
                                    ...
                                    <div class="item scale">
                                        <div class="contents clearfix">
                                            <div class="team-info">
                                                <div class="team-image">
                                                    <a class="single-image team-plus-icon" href="#"><img src="<?php echo e(asset('website/images/testimonials/mike-252x270.jpg')); ?>" alt="" /></a>
                                                </div>
                                                <hgroup class="team-group">
            ...
            <section class="section padding-bottom-off">
                ...
                <ul id="gallery-items" class="portfolio-items">
                    <li class="video mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-1.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">Petit</h2>
                                        <h6 class="extra-category">Video</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-1.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="branding mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-2.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">Isabela Rodrigues</h2>
                                        <h6 class="extra-category">Branding</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-2.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="logo mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-3.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">Illegal Burger ®</h2>
                                        <h6 class="extra-category">Logo</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-3.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="photo mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-4.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">Mercado Negro</h2>
                                        <h6 class="extra-category">Photo</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-4.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="logo mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-5.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">Kate & Julia</h2>
                                        <h6 class="extra-category">Logo</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-5.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="video mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-6.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">No Doubt</h2>
                                        <h6 class="extra-category">Video</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-6.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                    ...
                    <li class="branding mix mix_all opacity2x">
                        <div class="work-item"> <img src="<?php echo e(asset('website/images/gallery/gallery-sm-7.jpg')); ?>" alt="" />
                            <div class="image-extra">
                                <div class="extra-content">
                                    <div class="inner-extra">
                                        <h2 class="extra-title">AM1000 Studios</h2>
                                        <h6 class="extra-category">Branding</h6>
                                        <a class="single-image plus-icon" data-fancybox-group="folio" href="<?php echo e(asset('website/images/gallery/gallery-sm-7.jpg')); ?>"></a>
                                    </div>
                                    <!--/ .inner-extra-->
                                </div>
                                <!--/ .extra-content-->
                                        ...
                                        <div class="row margin-bottom">
                                            ...
                                            <div class="col-md-4">
                                                <div class="course_cur_wrap">
                                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/courses/cur-wrap-2.jpg')); ?>" alt="">
                                                        <div class="image-extra">
                                                            <div class="extra-content">
                                                                <div class="inner-extra">
                                                                    <a class="single-image link-icon" href="courses-single.html"></a>
                                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/courses/cur-wrap-2.jpg')); ?>"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="course_cur_wrap">
                                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/courses/cur-wrap.jpg')); ?>" alt="">
                                                        <div class="image-extra">
                                                            <div class="extra-content">
                                                                <div class="inner-extra">
                                                                    <a class="single-image link-icon" href="courses-single.html"></a>
                                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/courses/cur-wrap.jpg')); ?>"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="course_cur_wrap">
                                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/courses/cur-wrap-3.jpg')); ?>" alt="">
                                                        <div class="image-extra">
                                                            <div class="extra-content">
                                                                <div class="inner-extra">
                                                                    <a class="single-image link-icon" href="courses-single.html"></a>
                                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/courses/cur-wrap-3.jpg')); ?>"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 slideRight">
                            <article class="entry">
                                <div class="entry-image">
                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/blog/latest-blog-1.jpg')); ?>" alt="" />
                                        <div class="image-extra">
                                            <div class="extra-content">
                                                <div class="inner-extra">
                                                    <a class="single-image link-icon" href="blog-single.html"></a>
                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/blog/latest-blog-1.jpg')); ?>"></a>
                                                </div>
                                                <!--/ .inner-extra-->
                                            </div>
                                            <!--/ .extra-content-->
                        ...
                        <div class="col-sm-6 col-lg-4 slideUp">
                            <article class="entry">
                                <div class="entry-image">
                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/blog/latest-blog-2.jpg')); ?>" alt="" />
                                        <div class="image-extra">
                                            <div class="extra-content">
                                                <div class="inner-extra">
                                                    <a class="single-image link-icon" href="blog-single.html"></a>
                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/blog/latest-blog-2.jpg')); ?>"></a>
                                                </div>
                                                <!--/ .inner-extra-->
                                            </div>
                                            <!--/ .extra-content-->
                        ...
                        <div class="col-sm-6 col-lg-4 slideLeft">
                            <article class="entry">
                                <div class="entry-image">
                                    <div class="work-item"> <img src="<?php echo e(asset('website/images/blog/latest-blog-3.jpg')); ?>" alt="" />
                                        <div class="image-extra">
                                            <div class="extra-content">
                                                <div class="inner-extra">
                                                    <a class="single-image link-icon" href="blog-single.html"></a>
                                                    <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/blog/latest-blog-3.jpg')); ?>"></a>
                                                </div>
                                                <!--/ .inner-extra-->
                                            </div>
                                            <!--/ .extra-content-->
                        ...
                        <div class="col-xs-12">
                            <div id="partner-slider" class="owl-carousel owl-theme clients-items">
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-1.jpg')); ?>" alt="" /></a>
                                </div>
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-2.jpg')); ?>" alt="" /></a>
                                </div>
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-3.jpg')); ?>" alt="" /></a>
                                </div>
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-4.jpg')); ?>" alt="" /></a>
                                </div>
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-5.jpg')); ?>" alt="" /></a>
                                </div>
                                <div class="item opacity2x">
                                    <a href="#"><img src="<?php echo e(asset('website/images/clients/client-6.jpg')); ?>" alt="" /></a>
                                </div>
                            </div>
                            <!--/ .clients-items-->
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="news_des left">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-sm-6 thumb">
                                        <div class="work-item"> <img src="<?php echo e(asset('website/images/news/news1.jpg')); ?>" alt="" />
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                                        <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/news/news1.jpg')); ?>"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="news_des right">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-sm-6 thumb">
                                        <div class="work-item"> <img src="<?php echo e(asset('website/images/news/news2.jpg')); ?>" alt="" />
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                                        <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/news/news2.jpg')); ?>"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="news_des left">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-sm-6 thumb">
                                        <div class="work-item"> <img src="<?php echo e(asset('website/images/news/news3.jpg')); ?>" alt="" />
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                                        <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/news/news3.jpg')); ?>"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="news_des right">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-sm-6 thumb">
                                        <div class="work-item"> <img src="<?php echo e(asset('website/images/news/news4.jpg')); ?>" alt="" />
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                                        <a class="single-image plus-icon" data-fancybox-group="blog" href="<?php echo e(asset('website/images/news/news4.jpg')); ?>"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="<?php echo e(asset('website/js/scrolling-nav.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/jquery.easing.min.js')); ?>"></script>
    <!-- LayerSlider script files -->
    <script src="<?php echo e(asset('website/js/layerslider/js/greensock.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('website/js/layerslider/js/layerslider.transitions.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('website/js/layerslider/js/layerslider.kreaturamedia.jquery.js')); ?>" type="text/javascript"></script>
    <!-- Google Map -->

    <script src="<?php echo e(asset('website/js/jquery.gmap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/jquery.mixitup.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/fancybox/jquery.fancybox.pack.js')); ?>"></script>
    <!-- Owl Carousel -->
    <script src="<?php echo e(asset('website/js/owl/js/owl.carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/counter.js')); ?>"></script>
    <script src="<?php echo e(asset('website/js/script.js')); ?>"></script>
    <!-- Initializing the slider -->
</body>

</html>
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/website/home.blade.php ENDPATH**/ ?>