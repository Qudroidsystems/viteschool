...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbill/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbill/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbill/view/update-schoolbill.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/layouts/pages-assets/js/schoolbill-list-js.blade.php ENDPATH**/ ?>