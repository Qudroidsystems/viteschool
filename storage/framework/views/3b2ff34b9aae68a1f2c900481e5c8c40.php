...
<table id="tab" width="89%" height="693" border="0" cellspacing="0" frame="BOX" rule="NONE">
  <tbody border="1">
    <tr>
      <td width="135" height="128"><img src="<?php echo e(asset('schoolreport/rsslogo.jpeg')); ?>" width="135" height="119" alt="" class="img1"/></td>
      <td height="128" colspan="10"><img src="<?php echo e(asset('schoolreport/logo.jpeg')); ?>" width="485" height="125" alt="" class="logo1 img1"/></td>
        <?php
        ...
        ?>
          ...
          <img src="<?php echo e(asset('images/studentpics/'.$image)); ?>" width="135" height="127" alt="" class=" logo2 img2"/>
			  ...
			  <table width="200" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="63%"  style="font-size: 0.7em; border-bottom:none;"><strong> <?php echo e(strtoupper($broadsheet->tittle)); ?> &nbsp; <?php echo e(strtoupper($broadsheet->firstname)); ?> &nbsp; &nbsp; <?php echo e(strtoupper($broadsheet->lastname)); ?></strong></td>
		          </tr>
			      <tr>
			        <td  style="border-bottom: none"><div title="Page 1">
			         ...
			         <td width="63%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e(strtoupper($broadsheet->admissionno)); ?></strong></td>
		          </tr>
					<tr>
			        <td  style="border-bottom: none"><div title="Page 1">
			          <div>
			        ...
			        <td width="63%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e(strtoupper($broadsheet->gender)); ?></strong></td>
		          </tr><tr>
			        <td  style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="63%"  style="font-size: 0.8em; border-bottom:none;"><strong><?php echo e(strtoupper($broadsheet->house)); ?></strong></td>
		          </tr><tr>
			        <td  style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
                    ...
                    ?>
			        <td width="63%"  style="font-size: 0.8em; border-bottom:none"><strong><?php echo e($value->position); ?></strong></td>
		          </tr>
		        </tbody>
		      </table>
              </div>
			...
			<table width="200" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none "><strong><?php echo e(strtoupper($broadsheet->schoolclass)); ?> <?php echo e(strtoupper($broadsheet->arm)); ?></strong></td>
		          </tr>
			      <tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			        ...
			        <td width="48%"  style="font-size: 0.7em;  border-bottom:none"><strong><?php echo e($noofstudents); ?></strong></td>
		          </tr>
                  <?php if($chkclasssetting): ?>
                  <?php
                  foreach ($classsetting as $key => $cl) {
			       ...
			       <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e($cl->noschoolopened); ?> </strong></td>
		           </tr>
                  <?php elseif(!$chkclasssetting): ?>
                  ...
                  <tr>
			        ...
			        ?>
                    <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e($v->attendance); ?></strong></td>
		          </tr>
                  <?php if($chkclasssetting): ?>
                  <?php
                  foreach ($classsetting as $key => $cl) {
                  ...
                  <tr>
			        ...
			        <td width="48%"  style="font-size: 0.7em;  border-bottom:none"><strong><?php echo e(date( 'd F, Y',strtotime($cl->termends))); ?></strong></td>
		          </tr>
			      ...
			      <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e(date( 'd F, Y',strtotime($cl->nexttermbegins))); ?></strong></td>
		          </tr>
                  <?php elseif(!$chkclasssetting): ?>
    ...
    <tr id="tr1">
      ...
      <td width="25" align="justify" colspan="3" style="font-size: 0.8em">&nbsp; <strong><?php echo e($b->subject); ?></strong></td>
      <td width="48" align="center" style="font-size: 0.9em"><strong><?php echo e($b->ca1); ?></strong></td>
      <td width="31" align="center" style="font-size: 0.9em"><strong><?php echo e($b->ca2); ?></strong></td>
      <td width="48" align="center" style="font-size: 0.9em "> <strong> <?php echo e($b->exam); ?>  </strong></td>
    ...
    <?php if($b->grade == "F"): ?>
    <strong style="color: red"> <?php echo e($b->grade); ?></strong>
    <?php else: ?>
    <strong>
        <?php echo e($b->grade); ?>
    ...
    <?php endif; ?>
      ...
      <td width="32" align="center" style="font-size: 0.9em"><strong><?php echo e($b->position); ?></strong></td>
      <td width="80" align="center" style="font-size: 0.7em"><strong><?php echo e($b->remark); ?></strong></td>
      <td width="50" align="center" style="font-size: 0.9em"><strong><?php echo e($b->cmax); ?></strong></td>
      <td width="50" align="center" style="font-size: 0.9em"><strong><?php echo e($b->cmin); ?></strong></td>
      <td width="32" align="center" style="font-size: 0.9em"><strong><?php echo e($b->avg); ?></strong></td>
			  ...
			  <table width="200" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->punctuality)); ?></strong></td>
		          </tr>
			      <tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			         ...
			         <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->neatness)); ?></strong></td>
		          </tr>
					<tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->leadership)); ?></strong></td>
		          </tr><tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->attitude)); ?></strong></td>
		          </tr><tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->reading)); ?></strong></td>
		          </tr><tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="48%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->honesty)); ?></strong></td>
		          </tr>
		        </tbody>
		      </table>
			...
			<table width="200" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->cooperation)); ?></strong></td>
		          </tr>
			      <tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			        ...
			        <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->selfcontrol)); ?></strong></td>
		          </tr>
					<tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			       ...
			       <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->politeness)); ?></strong></td>
		          </tr><tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong> <?php echo e(strtoupper($b->physicalhealth)); ?></strong></td>
		          </tr><tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			            <div>
			        ...
			        <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e(strtoupper($b->stability)); ?></strong></td>
		          </tr>
					<tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			      ...
			      <td width="49%"  style="font-size: 0.7em; border-bottom:none"><strong><?php echo e(strtoupper($b->gamesandsports)); ?></strong></td>
		          </tr>
		        </tbody>
		      </table>
			  ...
			  <table width="200" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="53%"  style="font-size: 0.8em;border-bottom:none"><strong><?php echo e($subjectstotal); ?></strong></td>
		          </tr>
			      <tr>
			        <td style="border-bottom: none"><div title="Page 1">
			          <div>
			         ...
			         <td width="53%"  style="font-size: 0.8em; border-bottom:none"><strong><?php echo e(round($subjectsavg,2)); ?></strong></td>
		          </tr>
		        </tbody>
		      </table>
			  ...
			  <table width="300" border="0">
			    <tbody>
			      <tr>
			        ...
			        <td width="60%"  style="font-size: 0.7em; border-bottom:none"><?php echo e(strtoupper($b->classteachercomment)); ?></td>
		          </tr>
				  <tr>
			        <td width="40%" style="border-bottom: none"><div title="Page 1">
			          <div>
			      ...
			      <tr>
			        <td style="border-bottom: none"><div title="Page 1">
			         ...
			         <td width="60%"  style="font-size: 0.7em;  border-bottom:none"><?php echo e(strtoupper($b->principalscomment)); ?></td>
		          </tr>
		        </tbody>
		      </table>
...
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/studentresults/viewresult.blade.php ENDPATH**/ ?>