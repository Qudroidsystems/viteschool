...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolpayment/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolpayment/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolpayment/view/update-schoolpayment.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('html/assets/assets/js/custom/utilities/modals/pay-schoolbill.js')); ?>"></script>
<!--end::Custom Javascript-->
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/layouts/pages-assets/js/schoolpayment-list-js.blade.php ENDPATH**/ ?>