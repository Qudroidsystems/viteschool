...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/analysis/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/analysis/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/analysis/view/update-analysis.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/layouts/pages-assets/js/analysis-list-js.blade.php ENDPATH**/ ?>