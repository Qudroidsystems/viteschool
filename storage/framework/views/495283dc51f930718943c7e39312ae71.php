                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            ...
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                <?php echo e($s->schoolclass); ?>  <?php echo e($s->arm); ?>
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="<?php echo e($student_bill_info_count); ?>" data-kt-countup-prefix="">0</div>
                                </div>
                                <!--end::Number-->
...
<!--end::Navbar-->
  ...
  <div class="card-toolbar">
    <!--begin::Button-->
    <a href="<?php echo e(route('schoolpayment.index')); ?>" class="btn btn-primary">
                << Back
    </a>
    <!--end::Button-->
...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0"><p style="color: rgb(109, 109, 212)"> School Bills FOR &nbsp;&nbsp;<?php echo e(ucwords(strtolower($fn))); ?> <?php echo e(ucwords(strtolower($ln))); ?> (<?php echo e($ad); ?>) for <?php echo e($schoolterm); ?> | <?php echo e($schoolsession); ?> Academic Session</p></h3>
        </div>
        <!--end::Card title-->
    </div>
...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_billing_payment_tab_content" class="card-body tab-content">
        ...
        <div id="kt_billing_creditcard" class="tab-pane fade show active" role="tabpanel"">
            ...
            <div class="row gx-9 gy-6">
                <?php
                    ...
                    $balance = 0;
               ?>
                <?php $__currentLoopData = $student_bill_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-xl-6" data-kt-billing-element="card">
                        ...
                        <?php if((float)$actualAmount1 === (float)$amountPaid1 ): ?>
                        ...
                        <?php endif; ?>
                            ...
                            <div class="d-flex flex-column py-2">
                                ...
                                <div class="d-flex align-items-center fs-4 fw-bold mb-5">
                                    ...
                                    <span class="badge badge-light-info fs-7 ms-2"><?php echo e($sc->description); ?></span>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div>
                                        <div class="fs-4 fw-bold"><h2>₦ <?php echo e(number_format($sc->amount)); ?></h2></div>
                                    <?php
                                        $paymentFound = false;
                                        $amountPaid = 0;
                                        $balance = 0;
                                    ...
                                    <?php if($paymentFound): ?>
                                        <div class="fs-6 fw-semibold " style="color: rgb(23, 100, 67)">Amount Paid: ₦ <?php echo e(number_format($amountPaid)); ?> </div>
                                        <div class="fs-6 fw-semibold " style="color: rgb(190, 32, 11)"> Outstanding: ₦ <?php echo e(number_format($balance)); ?></div>
                                    <?php else: ?>
                                    <?php
                                         if((float)$amountPaid == 0){
                                                $balance = $sc->amount;
                                    ...
                                    ?>
                                        ...
                                        <div class="fs-6 fw-semibold ">Amount Paid: ₦ <?php echo e(number_format($amountPaid)); ?> </div>
                                        <div class="fs-6 fw-semibold " style="color: rgb(190, 32, 11)">Outstanding: ₦ <?php echo e(number_format($balance)); ?></div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="d-flex align-items-center py-2">
                                <button class="btn btn-sm btn-light btn-primary"
                                    data-student_id="<?php echo e($s->id); ?>"
                                    data-amount="<?php echo e(number_format($sc->amount)); ?>"
                                    data-amount_actual="<?php echo e($sc->amount); ?>"
                                    data-amount_paid="<?php echo e(number_format($amountPaid)); ?>"
        ...
        <div id="kt_billing_paypal" class="tab-pane fade" role="tabpanel" aria-labelledby="kt_billing_paypal_tab">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <?php $__currentLoopData = $studentpaymentbill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>  <input type="hidden" id="tid"  value="<?php echo e($sp->paymentid); ?>" /><?php echo e(++$i); ?></td>
                                            <td class="d-flex align-items-center"><?php echo e($sp->title); ?></td>
                                            <td > <?php echo e($sp->description); ?></td>
                                            <td > ₦ <?php echo e(number_format($sp->billAmount)); ?> </td>
                                            
                                            <td style="color: rgb(53, 12, 119)"> ₦ <?php echo e(number_format(intval($sp->lastPayment) ?? 0)); ?> </td>
                                            <td style="color: rgb(190, 32, 11)"> ₦ <?php echo e(number_format($sp->balance)); ?></td>
                                            <td > <?php echo e($sp->recievedBy); ?></td>
                                            <td > <?php echo e($sp->recievedDate); ?></td>
                                            <td > <?php echo e($sp->paymentMethod); ?></td>
                                            <td > <?php echo e($sp->paymentStatus); ?></td>
                                            <td >
                                                ...
                                                <div class="menu-item px-3" >
                                                    ...
                                                    data-url="<?php echo e(route('schoolpayment.deletestudentpayment', ['paymentid'=> $sp->paymentid])); ?>"
         ...
         <?php if($studentpaymentbill->isNotEmpty()): ?>
          <a href="#"
                                                    ...
                                                    <div class="col-xl-12" data-kt-billing-element="card">
                                                        ...
                                                        <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                                            ...
                                                            <div class="d-flex flex-column py-2">
                                                                ...
                                                                <span class="badge badge-light-info fs-7 ms-2"><?php echo e($s->description); ?></span>
                                                                <!--end::Owner-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/schoolpayment/studentpayment.blade.php ENDPATH**/ ?>