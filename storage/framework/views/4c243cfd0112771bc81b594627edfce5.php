...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myclass/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/account/settings/profile-details.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myclass/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myclass/view/update-myclass.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/layouts/pages-assets/js/myclass-list-js.blade.php ENDPATH**/ ?>