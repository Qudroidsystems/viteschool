                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('student.index')); ?>" class="text-muted text-hover-primary">Student's Result  </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                ...
                <div class="col-md d-flex flex-column">
                    <div class="w-100 d-flex justify-content-center align-items-center pt-1">
                        <div class="school-logo">
                            <img src=" <?php echo e(asset('print-main/public/assets/tp.png')); ?>" class="w-100 h-100" alt="">
                        </div>
                        <div>
            ...
            <div class="row mb-2 d-flex flex-row">
                ...
                <div class="col bg-white d-flex justify-content-center align-items-center" >
                    <div class="h-100 bg-light" style="width: 90%; box-shadow: 50px">
                        ...
                        <img src=" <?php echo e(asset('print-main/public/assets/siji.jpg')); ?>" class="w-100 h-100" alt="">
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/studentresults/classresults.blade.php ENDPATH**/ ?>