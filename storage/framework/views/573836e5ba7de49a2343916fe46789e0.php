            ...
            <div id="kt_app_content_container" class="app-container">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body border-top p-9">
                        <form id="student-edit-form" method="POST" action="<?php echo e(route('student.update', $student->sid)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="admissionNo" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->admissionNo); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-lg form-control-solid" name="title" required>
                                        <option value="" <?php echo e(!$student->title ? 'selected' : ''); ?>>Select Title</option>
                                        <option value="Mr" <?php echo e($student->title == 'Mr' ? 'selected' : ''); ?>>Mr</option>
                                        <option value="Mrs" <?php echo e($student->title == 'Mrs' ? 'selected' : ''); ?>>Mrs</option>
                                        <option value="Miss" <?php echo e($student->title == 'Miss' ? 'selected' : ''); ?>>Miss</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <input type="text" name="firstname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="<?php echo e($student->firstname); ?>" required />
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" name="lastname" class="form-control form-control-lg form-control-solid" placeholder="Last name" value="<?php echo e($student->lastname); ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="othername" class="form-control form-control-lg form-control-solid" placeholder="Other names" value="<?php echo e($student->othername); ?>" />
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="d-flex align-items-center mt-3">
                                        <label class="form-check form-check-custom form-check-inline form-check-solid me-5">
                                            <input class="form-check-input" name="gender" type="radio" value="Male" <?php echo e($student->gender == 'Male' ? 'checked' : ''); ?> required />
                                            <span class="fw-semibold ps-2 fs-6">Male</span>
                                        </label>
                                        <label class="form-check form-check-custom form-check-inline form-check-solid">
                                            <input class="form-check-input" name="gender" type="radio" value="Female" <?php echo e($student->gender == 'Female' ? 'checked' : ''); ?> required />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="home_address" class="form-control form-control-lg form-control-solid" placeholder="Address" value="<?php echo e($student->homeadd); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="home_address2" class="form-control form-control-lg form-control-solid" placeholder="Address" value="<?php echo e($student->homeadd2); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="date" name="dateofbirth" id="dateofbirth" oninput="showage()" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->dob); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="age" id="age" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->age); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="placeofbirth" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->pob); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="nationality" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->nationality); ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-lg form-control-solid" name="religion" required>
                                        ...
                                        <option value="Others" <?php echo e($student->religion == 'Others' ? 'selected' : ''); ?>>Others</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="last_school" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->lastsch); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="last_class" class="form-control form-control-lg form-control-solid" value="<?php echo e($student->lastclass); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-lg form-control-solid" name="schoolclassid" required>
                                        ...
                                        <?php $__currentLoopData = $schoolclass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($class->id); ?>" <?php echo e($student->sclassid == $class->id ? 'selected' : ''); ?>>
                                                <?php echo e($class->schoolclass); ?> - <?php echo e($class->arm); ?>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-lg form-control-solid" name="termid" required>
                                        ...
                                        <?php $__currentLoopData = $schoolterm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($term->id); ?>" <?php echo e($student->termid == $term->id ? 'selected' : ''); ?>>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-lg form-control-solid" name="sessionid" required>
                                        ...
                                        <?php $__currentLoopData = $schoolsession; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($session->id); ?>" <?php echo e($student->sessionid == $session->id ? 'selected' : ''); ?>>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <div class="d-flex align-items-center mt-3">
                                        <label class="form-check form-check-custom form-check-inline form-check-solid me-5">
                                            <input class="form-check-input" name="statusId" type="radio" value="1" <?php echo e($student->statusId == 1 ? 'checked' : ''); ?> required />
                                            <span class="fw-semibold ps-2 fs-6">Old Student</span>
                                        </label>
                                        <label class="form-check form-check-custom form-check-inline form-check-solid">
                                            <input class="form-check-input" name="statusId" type="radio" value="2" <?php echo e($student->statusId == 2 ? 'checked' : ''); ?> required />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if($student->picture): ?>
                                        <img src="<?php echo e(asset('storage/' . $student->picture)); ?>" alt="Current Avatar" style="max-width: 100px; margin-top: 10px;">
                                    <?php endif; ?>
                                </div>
                            </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var selectedState = "<?php echo e($student->state); ?>";
        if (selectedState) {
        ...
        var selectedLocalGovernment = "<?php echo e($student->local); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/student/edit.blade.php ENDPATH**/ ?>