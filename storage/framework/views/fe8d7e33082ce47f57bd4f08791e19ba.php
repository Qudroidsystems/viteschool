                                                                        ...
                                                                        <?php if($subRegStatuschk): ?>
                                                                                    ...
                                                                                    <?php if($subRegStatuschk): ?>
                                                                                            ...
                                                                                            <?php echo Form::open(['method' => 'DELETE','route' => ['subjectoperation.destroy', $broadsheetid],'style'=>'display:inline']); ?>
                                                                                               ...
                                                                                               <input type="hidden" value="<?php echo e($sc->subjectclassid); ?>" name="subjectclassid">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viteschool\resources\views/subjectoperation/subjectinfo.blade.php ENDPATH**/ ?>