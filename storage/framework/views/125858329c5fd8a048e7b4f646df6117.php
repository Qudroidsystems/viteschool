...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/schoolbilltermsession/view/update-schoolbilltermsession.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\viteschool\resources\views/layouts/pages-assets/js/schoolbilltermsession-list-js.blade.php ENDPATH**/ ?>