                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_add_user_form" class="form" action="<?php echo e(route('analysis.analysisClassTermSession')); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <!--begin::Scroll-->
                                                                    ...
                                                                    <div class="mb-7">
                                                                        ...
                                                                        <!--end::Label-->
                                                                                ...
                                                                                <div class="fv-row mb-7">
                                                                                        ...
                                                                                        <select name ="class_name" id="class_name" data-control="select2" data-placeholder="Select an option" data-hide-search="true" class="form-select form-select-solid form-select-lg fw-semibold fs-6 text-gray-700">
                                                                                            ...
                                                                                            <?php $__currentLoopData = $schoolclasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schoolclass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                             <option value="<?php echo e($schoolclass->schoolclass); ?>">All classes in <?php echo e($schoolclass->schoolclass); ?></option>
                                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                        </select>
                                                                                        <!--end::Input-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/schoolpayment/analysis.blade.php ENDPATH**/ ?>