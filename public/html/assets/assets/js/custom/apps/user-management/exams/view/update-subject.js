            ...
            form,
            {
                fields: {
                    ...
                    'update_examscode': {
                        validators: {
                            notEmpty: {
                                message: 'exams Code is required'
                            }
                        }
                    },
                    'update_remark': {
...
$(function () {
    ...
    // ON SELECTING ROW
    $(".sel-exams").click(function () {
      //FINDING ELEMENTS OF ROWS AND STORING THEM IN VARIABLES
    var id = $(this).parents("tr").find("#tid").val();
    var a = $.trim($(this).parents("tr").find(".exams").text());
    var b = $.trim($(this).parents("tr").find(".examscode").text());
    var c = $.trim($(this).parents("tr").find(".remark").text());
       ...
       + '<div class="fv-row mb-10">'
        ...
        +'<label class="required fw-semibold fs-6 mb-2">exams Name</label>'



        +'<input type="text" name="exams" id="update_exams" value="'+a+'" class="form-control form-control-solid mb-3 mb-lg-0"   required  />'
        ...
        +'<label class="required fw-semibold fs-6 mb-2">exams Code</label>'



        +'<input type="text" name="exams_code" id="update_examscode" value="'+b+'" class="form-control form-control-solid mb-3 mb-lg-0"  required   />'
